        ...
        <br><br>
            <section>
                ...
                ?>
                    ...
                    <tr>
                    <form method="post" action="alterar2.php" onsubmit="return confirmacao()">
                    ...
                    <input type="text" name="data" id=data class="form-control text-center" value="<?=$linha['DataNasc']?>"></td>
                    <td><?=$linha['DataHora']?>
                    </td>
